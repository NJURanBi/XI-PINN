...
def train_neural_network(n_input, n_hidden, n_output, n_layers, num_op, num_on, num_b, num_ini, num_if, v_p, v_n, SOAP_lr, SOAP_epochs, LM_epochs, device):
    # 初始的mu值，将会放到初始参数设置
    mu = 1e5
    mu_div = 3.
    mu_mul = 2.
    ...
    data_op_tr, data_on_tr, data_b_tr, data_if_phi_tr, data_if_psi_tr, data_ini_tr = generate_train_data(num_op, num_on, num_ini, num_b, num_if, device)
