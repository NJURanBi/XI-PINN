...
def main(paras):
    ...
    '''
    model = Vanilla_Net(5, 64, 1, 3).to(device)
    ...
    error_plot(paras.v_p, paras.v_n, model, func_params, device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_op', type=int, default=1000)
    parser.add_argument('--num_on', type=int, default=200)
    parser.add_argument('--num_b', type=int, default=500)
    parser.add_argument('--num_ini', type=int, default=500)
    parser.add_argument('--num_if', type=int, default=500)
    parser.add_argument('--v_p', type=float, default=10)
    parser.add_argument('--v_n', type=float, default=1)
    parser.add_argument('--SOAP_lr', type=float, default=1e-3)
    parser.add_argument('--SOAP_epochs', type=int, default=10000)
