...
if __name__ == '__main__':
    ...
    parser.add_argument('--V_n_input', type=int, default=4)
    parser.add_argument('--V_n_hidden', type=int, default=64)
    parser.add_argument('--V_n_output', type=int, default=2)
    parser.add_argument('--V_n_layers', type=int, default=2)
    # Neural network parameters: pressure nural network
    parser.add_argument('--P_n_input', type=int, default=4)
    parser.add_argument('--P_n_hidden', type=int, default=32)
    ...
    parser.add_argument('--num_b', type=int, default=800)
    ...
    parser.add_argument('--nu_n', type=float, default=1e-3)
