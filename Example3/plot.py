...
cases = [
    # X-PINN
    ('X-PINN',   'small',  '3', '23', 'loss_data_XPINN_small.npz',   'relative_errors_data_XPINN_small.npz'),
    ('X-PINN',   'medium', '3', '45', 'loss_data_XPINN_medium.npz',   'relative_errors_data_XPINN_medium.npz'),
    ('X-PINN',   'large',  '4', '45', 'loss_data_XPINN_large.npz',   'relative_errors_data_XPINN_large.npz'),
    # XI-PINN
    ('XI-PINN',  'small',  '3', '32', 'loss_data_XIPINN_small.npz',  'relative_errors_data_XIPINN_small.npz'),
    ('XI-PINN',  'medium', '3', '64', 'loss_data_XIPINN_medium.npz',  'relative_errors_data_XIPINN_medium.npz'),
    ('XI-PINN',  'large',  '4', '64', 'loss_data_XIPINN_large.npz',  'relative_errors_data_XIPINN_large.npz'),
    # XI-PINN*
    ('XI-PINN*', 'small',  '3', '32', 'loss_data_XIPINNstar_small.npz', 'relative_errors_data_XIPINNstar_small.npz'),
    ('XI-PINN*', 'medium', '3', '64', 'loss_data_XIPINNstar_medium.npz', 'relative_errors_data_XIPINNstar_medium.npz'),
    ('XI-PINN*', 'large',  '4', '64', 'loss_data_XIPINNstar_large.npz', 'relative_errors_data_XIPINNstar_large.npz'),
]
