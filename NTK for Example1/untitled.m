...
title('Eigenvalue of $\mathcal{K}$', 'Interpreter', 'latex');
xlabel('Index');
...
xlim([1 1000]);
legend('XI-PINN', 'Vanilla-PINN');
title('Eigenvalue of $\mathcal{K}_{\Omega}$', 'Interpreter', 'latex');
xlabel('Index');
ylabel('$\lambda$', 'Interpreter', 'latex');
set(gca,'LooseInset',get(gca,'TightInset'))
%% NTK_b
...
xlim([1 500]);
legend('XI-PINN', 'Vanilla-PINN');
title('Eigenvalue of $\mathcal{K}_b$', 'Interpreter', 'latex');
xlabel('Index');
ylabel('$\lambda$', 'Interpreter', 'latex');
set(gca,'LooseInset',get(gca,'TightInset'))
%% NTK_ini
...
xlim([1 100]);
legend('XI-PINN', 'Vanilla-PINN');
title('Eigenvalue of $\mathcal{K}_0$', 'Interpreter', 'latex');
xlabel('Index');
ylabel('$\lambda$', 'Interpreter', 'latex');
set(gca,'LooseInset',get(gca,'TightInset'))
%%
...
xlim([1 400]);
legend('XI-PINN', 'Vanilla-PINN');
title('Eigenvalue of $\mathcal{K}_\Gamma$', 'Interpreter', 'latex');
xlabel('Index');
ylabel('$\lambda$', 'Interpreter', 'latex');
set(gca,'LooseInset',get(gca,'TightInset'))
%% covergence rate
...
c_xi_par = sum(D_xi_o) / 1000 + sum(D_xi_b) / 500 + sum(D_xi_if) / 400 + sum(D_xi_ini) / 100;
c_van_par = sum(D_van_o) / 1000 + sum(D_van_b) / 500 + sum(D_van_if) / 400 + sum(D_van_ini) / 100;